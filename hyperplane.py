...
class Hyperplane(object):
    ...
    EITHER_DIM_OR_NORMAL_VEC_MUST_BE_PROVIDED_MSG = 'Either the dimension of the hyperplane or a normal vector is required'
    ...
    def __init__(self, dimension=None, normal_vector=None, constant_term=None):
        ...
        if not dimension and not normal_vector:
            ...
            self.dimension = dimensionall_zeros = [0]* self.dimension
